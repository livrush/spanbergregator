        ...
        if (position === 'Yes') {
            return (
                <li className="list-group-item bg-success">
                    <h5 className="m-0"><i className="fas fa-check text-light"></i></h5>
                </li>
            )
        } else if (position === 'No') {
            return (
                <li className="list-group-item bg-danger">
                    <h5 className="m-0"><i className="fas fa-times text-light"></i></h5>
                </li>
            );
        }
    };
        ...
        <li className="vote list-group-item position-relative">
            <div className="row">
                <div className="col-6 col-sm-4 col-md-3">
                    <ul className="list-group">
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                <div className="col-6">
                                    <i className="fas text-success fa-thumbs-up"></i>
                                </div>
                                <div className="col-6">
                                    { vote.total.yes }
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                <div className="col-6">
                                    <i className="fas text-danger fa-thumbs-down"></i>
                                </div>
                                <div className="col-6">
                                    { vote.total.no }
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                <div className="col-6">
                                    <i className="fas text-warning fa-hand-point-right"></i>
                                </div>
                                <div className="col-6">
                                    { vote.total.present }
                                </div>
                        ...
                        <li className="list-group-item">
                            <div className="row">
                                <div className="col-6">
                                    <i className="fas text-dark fa-hand-paper"></i>
                                </div>
                                <div className="col-6">
                ...
                <div className="col-6 col-sm-8 col-md-9 text-left">
                    ...
                    <label className="font-weight-bold" for="latest-action">Latest Action:</label>
